<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<ul class="nav menu">
		...
		<li class="active"><a href="{{ url('/admin') }}"><span class="glyphicon glyphicon-list-alt"></span> Formularios</a></li>
		<li><a href="{{ url('/admin/users') }}"><span class="glyphicon glyphicon-list-alt"></span> Administradores</a></li>
