...
CREATE TABLE ASP_Idioma(
    ...
    CONSTRAINT FK_Asp_Idm_Escr FOREIGN KEY (Idm_ID_Niv_Escr) REFERENCES ASP_Nivel(Idm_ID),
    CONSTRAINT FK_Asp_Idm_Lect FOREIGN KEY (Idm_ID_Niv_Lect) REFERENCES ASP_Nivel(Idm_ID),
    CONSTRAINT FK_Asp_Idm_Conv FOREIGN KEY (Idm_ID_Niv_Conv) REFERENCES ASP_Nivel(Idm_ID)
);
